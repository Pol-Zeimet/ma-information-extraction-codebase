...
from tf2crf.other_losses import compute_dsc_loss
...
class ModelWithCRFLoss(tf.keras.Model):
    ...
    def compute_loss(self, x, y, sample_weight, training=False):
        crf_output, embeddings = self(x, training=training)
        viterbi_sequence, potentials, sequence_length, chain_kernel = crf_output
