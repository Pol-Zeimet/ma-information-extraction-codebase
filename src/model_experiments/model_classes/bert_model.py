...
from model_experiments.experiments.config import Config
from model_experiments.model_classes.model_architectures.bert_architecture import Bert
from util.metrics.baseline_metrics import accuracy_score, recall_score, precision_score, f1_score
from util.metrics.levenshtein import postprocess_tokens
from util.plot import create_confusion_matrix
import numpy as np
...
class BertModel:
    ...
    def _compute_metrics(self, p):
        ...
        mlflow.log_metric(self.trainer_state + "_macro_accuracy", macro_acc)
        mlflow.log_metric(self.trainer_state + "_macro_f1", macro_f1)
        mlflow.log_metric(self.trainer_state + "_macro_recall", macro_recall)
        mlflow.log_metric(self.trainer_state + "_macro_precision", macro_precision)
