...
penalty = 0.01
lr_s = [0.00005, 0.0001, 0.0005, 0.001, 0.005]
train_test_split = 0.25
exp = []
model_ids = ['Graph_Model_CRFv3_0_fold_5_classes',
             'Graph_Model_CRFv3_1_fold_5_classes',
             'Graph_Model_CRFv3_2_fold_5_classes']
...
exp.extend(GraphExperiment(GraphNetConfig(batch_size=batch_size,
                           ...
                           data_src=os.path.join(os.path.dirname(__file__), '../../data/SROIE/graphs_w2v/'),
                           label_src=os.path.join(os.path.dirname(__file__), '../../data/SROIE/labels_w2v/'),
                           additional_data_src=os.path.join(os.path.dirname(__file__),
                                                            '../../data/SROIE/results_df_v2.json'),
                           labels=labels,
...
batch_size = 2
model_ids = ['Graph_Model_CRFv3_3_fold_5_classes']
