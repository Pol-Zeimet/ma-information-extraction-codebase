...
exp = []
model_ids = ['Graph_Model_SoftmaxConcat_0_fold_5_classes',
             'Graph_Model_SoftmaxConcat_1_fold_5_classes',
             'Graph_Model_SoftmaxConcat_2_fold_5_classes']
...
batch_size = 2
model_ids = ['Graph_Model_SoftmaxConcat_3_fold_5_classes']
exp.extend(GraphExperiment(GraphNetConfig(batch_size=batch_size,
                                          n_train_epochs=n_train_epochs,
                                          n_folds=int(model_id.split('_')[3]),
                                          penalty=penalty,
